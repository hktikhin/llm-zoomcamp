...
ollama_client = OpenAI(base_url=OLLAMA_URL, api_key="ollama", default_headers = {"Authorization": f"token {OLLAMA_AUTH_TOKEN}"})
...
def evaluate_relevance(question, answer):
    ...
    evaluation, tokens, _ = llm(prompt, 'ollama/mistral-nemo')
